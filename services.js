...
const heights = ['16.66666666666667%', '33.33333333333333%', '50%', '66.66666666666667%', '83.33333333333334%', '100%']; // heights in percentage

// Initial setup
(progressLine && (progressLine.style.height = heights[0]));
(servicesHero && (servicesHero.style.background = bgColors[0]));
(progressStart && (progressStart.textContent = String(bgNumber).padStart(2, '0'))); // "01"
